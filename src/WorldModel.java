    ...
    */
    ...
    private void parseDude(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Dude.DUDE_NUM_PROPERTIES) {
            DudeNotFull entity = new DudeNotFull(id, pt,  imageStore.getImageList(Dude.DUDE_KEY), Double.parseDouble(properties[Dude.DUDE_ACTION_PERIOD_IDX]), Double.parseDouble(properties[Dude.DUDE_ANIMATION_PERIOD_IDX]), Integer.parseInt(properties[Dude.DUDE_RESOURCE_LIMIT_IDX]));
            this.tryAddEntity(entity);
        }else{
    ...
    private void parseFairy(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Fairy.FAIRY_NUM_PROPERTIES) {
            Fairy entity = new Fairy(id, pt, imageStore.getImageList(Fairy.FAIRY_KEY), Double.parseDouble(properties[Fairy.FAIRY_ACTION_PERIOD_IDX]), Double.parseDouble(properties[Fairy.FAIRY_ANIMATION_PERIOD_IDX]));
            this.tryAddEntity(entity);
        }else{
    ...
    private void parseTree(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Tree.TREE_NUM_PROPERTIES) {
            Tree entity = new Tree(id, pt,  imageStore.getImageList(Tree.TREE_KEY), Double.parseDouble(properties[Tree.TREE_ACTION_PERIOD_IDX]), Double.parseDouble(properties[Tree.TREE_ANIMATION_PERIOD_IDX]), Integer.parseInt(properties[Tree.TREE_HEALTH_IDX]));
            this.tryAddEntity(entity);
        }else{
    ...
    private void parseObstacle(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Obstacle.OBSTACLE_NUM_PROPERTIES) {
            Obstacle entity = new Obstacle(id, pt, Double.parseDouble(properties[Obstacle.OBSTACLE_ANIMATION_PERIOD_IDX]), imageStore.getImageList(Obstacle.OBSTACLE_KEY));
            this.tryAddEntity(entity);
        }else{
